            ...
            <div className="post-single">
              ...
              <div className="post-details">
                <div className="post-meta d-flex justify-content-between">
                  <div className="category"><Link to="#">Business</Link><Link to="#">Financial</Link></div>
                </div>
                <h1>Diversity in Engineering: The Effect on Questions<Link to="#"><i className="fa fa-bookmark-o"></i></Link></h1>
                <div className="post-footer d-flex align-items-center flex-column flex-sm-row"><Link to="#" className="author d-flex align-items-center flex-wrap">
                    <div className="avatar"><img src="img/avatar-1.jpg" alt="..." className="img-fluid" /></div>
                    <div className="title"><span>John Doe</span></div></Link>
                ...
                <div className="post-tags"><Link to="#" className="tag">#Business</Link><Link to="#" className="tag">#Tricks</Link><Link to="#" className="tag">#Financial</Link><Link to="#" className="tag">#Economy</Link></div>
                <div className="posts-nav d-flex justify-content-between align-items-stretch flex-column flex-md-row"><Link to="#" className="prev-post text-left d-flex align-items-center">
                    ...
                    </div></Link><Link to="#" className="next-post text-right d-flex align-items-center justify-content-end">
                    <div className="text"><strong className="text-primary">Next Post </strong>
                      <h6>I Bought a Wedding Dress.</h6>
                    </div>
                    <div className="icon next"><i className="fa fa-angle-right">   </i></div></Link></div>
